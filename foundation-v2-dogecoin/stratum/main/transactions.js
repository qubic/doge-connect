...
const Transactions = function(config, rpcData) {
  ...
  this.configMainnet = {
    bech32: '',
    bip32: {
      public: Buffer.from('02FACAFD', 'hex').readUInt32LE(0),
      private: Buffer.from('02FAC398', 'hex').readUInt32LE(0),
    },
    peerMagic: 'c0c0c0c0',
    pubKeyHash: Buffer.from('1E', 'hex').readUInt8(0),
    scriptHash: Buffer.from('16', 'hex').readUInt8(0),
    wif: Buffer.from('9E', 'hex').readUInt8(0),
    coin: 'doge',
  };
  ...
  this.configTestnet = {
    ...
    peerMagic: 'fcc1b7dc',
    pubKeyHash: Buffer.from('71', 'hex').readUInt8(0),
    scriptHash: Buffer.from('C4', 'hex').readUInt8(0),
    wif: Buffer.from('F1', 'hex').readUInt8(0),
    coin: 'doge',
  };
