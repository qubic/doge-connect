...
function mockClient() {
  ...
  client.id = 'test';
  client.addrPrimary = 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd';
...
describe('Test pool functionality', () => {
  ...
  test('Test pool settings setup [2]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.setupSettings(() => {
        expect(configCopy.primary.address).toBe('D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd');
  ...
  test('Test pool settings setup [3]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:22555')
        .post('/').reply(200, JSON.stringify([
          { id: 'nocktest', error: true, result: { isvalid: true, address: 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd' }},
          { id: 'nocktest', error: null, result: { networkhashps: 0 }},
          { id: 'nocktest', error: null, result: { difficulty: 0, testnet: false, connections: 10, }},
        ]));
      pool.setupSettings(() => {});
  ...
  test('Test pool settings setup [4]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:22555')
        .post('/').reply(200, JSON.stringify([
          { id: 'nocktest', error: null, result: { isvalid: false, address: 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd' }},
          { id: 'nocktest', error: null, result: { networkhashps: 0 }},
          { id: 'nocktest', error: null, result: { difficulty: 0, testnet: false, connections: 10, }},
        ]));
      pool.setupSettings(() => {});
    ...
    pool.on('pool.log', (type, text) => {
      if (type !== 'debug') {
        ...
        if (response.length === 2) {
          ...
          expect(response[0][1]).toBe('Submitted a primary block (Dogecoin:1) successfully to Dogecoin\'s daemon instance(s)');
  ...
  test('Test pool manager setup [9]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      if (type !== 'debug') {
        ...
        expect(text).toBe('Submitted a primary block (Dogecoin:1) successfully to Dogecoin\'s daemon instance(s)');
        done();
      }
    });
    mockSetupDaemons(pool, () => {
    ...
    pool.on('pool.log', (type, text) => {
      if (type !== 'debug') {
        ...
        if (response.length === 2) {
          ...
          expect(response[1][1]).toBe('Requested template from primary chain (Dogecoin:2) via RPC polling');
          done();
        }
      }
    });
    ...
    pool.on('pool.log', (type, text) => {
      if (type !== 'debug') {
        ...
        if (response.length === 3) {
          ...
          expect(response[2][1]).toBe('Requested template from primary chain (Dogecoin:1) via RPC polling');
          done();
        }
      }
    });
    ...
    pool.on('pool.log', (type, text) => {
      if (type !== 'debug') {
        ...
        if (response.length === 2) {
          pool.network.on('network.stopped', () => done());
          expect(response[1][0]).toBe('log');
          expect(response[1][1]).toBe('Difficulty update queued for worker: D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd (8)');
          pool.network.stopNetwork();
        }
      }
    });
    ...
    pool.on('pool.log', (type, text) => {
      if (type !== 'debug') {
        ...
        if (response.length === 2) {
          ...
          expect(response[0][1]).toBe('Network difficulty (0) is lower than the difficulty on port 3002 (32)');
          expect(response[1][0]).toBe('log');
          expect(response[1][1]).toBe('Difficulty updated successfully for worker: D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd (8)');
          pool.network.stopNetwork();
        }
      }
    });
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:22555')
        ...
        .reply(200, JSON.stringify({
          id: 'nocktest',
          error: null,
          result: { isvalid: true, address: 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd' }
        }));
      pool.checkWorker(pool.primary.daemon, 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd', (valid) => {
  ...
  test('Test pool stratum authentication [2]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkWorker(pool.primary.daemon, 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd.worker1', (valid) => {
        expect(valid).toBe(true);
        done();
      });
    });
  ...
  test('Test pool stratum authentication [3]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkPrimaryWorker('0.0.0.0', 3001, 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd', (valid) => {
        expect(valid).toBe(true);
        done();
      });
    });
    ...
    mockSetupDaemons(pool, () => {
      nock('http://127.0.0.1:22555')
        ...
        .reply(200, JSON.stringify({
          id: 'nocktest',
          error: null,
          result: { isvalid: false, address: 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd' }
        }));
      pool.checkPrimaryWorker('0.0.0.0', 3001, 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd', () => {}, (result) => {
  ...
  test('Test pool stratum authentication [6]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkAuxiliaryWorker('0.0.0.0', 3001, 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd', (valid) => {
        expect(valid).toBe(true);
        done();
      });
    });
  ...
  test('Test pool stratum authentication [7]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.checkAuxiliaryWorker('0.0.0.0', 3001, 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd', () => {}, (result) => {
        expect(result).toStrictEqual({ 'error': null, 'authorized': false, 'disconnect': false });
        done();
      });
    });
  ...
  test('Test pool stratum authentication [10]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.authorizeWorker('0.0.0.0', 3001, 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd', null, 'test', (result) => {
  ...
  test('Test pool stratum authentication [11]', (done) => {
    ...
    mockSetupDaemons(pool, () => {
      ...
      pool.authorizeWorker('0.0.0.0', 3001, 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd', 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd', 'test', (result) => {
        expect(result).toStrictEqual({ 'error': null, 'authorized': true, 'disconnect': false });
        done();
      });
    });
  ...
  test('Test pool workers handling [1]', () => {
    ...
    const blocks1 = {
      ...
      miner: 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd',
      worker: 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd.worker1',
      category: 'immature',
      confirmations: 3,
    ...
    const worker1 = {
      ...
      miner: 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd',
      worker: 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd.worker4',
      identifier: 'master',
      invalid: 0,
      round: '15c8343c-9751-4c67-aafa-29ff296da484',
      solo: false,
    ...
    const expected = { 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd': { 'immature': 10000, 'generate': 0 }};
  ...
  test('Test pool workers handling [2]', () => {
    ...
    const expected = { 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd': { 'generate': 0, 'immature': 20000 }};
  ...
  test('Test pool workers handling [3]', () => {
    ...
    worker2.miner = 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qe';
    worker2.worker = 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qe.worker4';
    const expected = {
      'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd': { 'immature': 5000, 'generate': 0 },
      'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qe': { 'immature': 5000, 'generate': 0 }};
  ...
  test('Test pool workers handling [4]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd': { 'immature': 8474.10994411, 'generate': 0 },
      'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qe': { 'immature': 1525.89005589, 'generate': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1, worker2]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [5]', () => {
    ...
    const expected = { 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd': { 'generate': 10000, 'immature': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [6]', () => {
    ...
    const expected = { 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd': { 'immature': 0, 'generate': 20000 }};
    pool.handlePrimaryWorkers([blocks1, blocks1], [[worker1], [worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [9]', () => {
    ...
    const expected = { 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd': { 'immature': 0, 'generate': -10000 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [12]', () => {
    ...
    const expected = {
      'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd': { 'immature': 9570.0056964, 'generate': 0 },
      'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qe': { 'immature': 429.9943036, 'generate': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1, worker2]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [14]', () => {
    ...
    const expected = { 'D9JbegQSnNV8RDnGHEi8Gw5ZnnJFUmD8Qd': { 'immature': -10000, 'generate': 10000 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], true, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [25]', () => {
    const pool = new Pool(configCopy, configMainCopy, () => {});
    const blocks1 = {
      id: '1',
      timestamp: '1662753912672',
  ...
  test('Test pool workers handling [26]', () => {
    const pool = new Pool(configCopy, configMainCopy, () => {});
    const blocks1 = {
      id: '1',
      timestamp: '1662753912672',
  ...
  test('Test pool workers handling [27]', () => {
    const pool = new Pool(configCopy, configMainCopy, () => {});
    const blocks1 = {
      id: '1',
      timestamp: '1662753912672',
  ...
  test('Test pool workers handling [28]', () => {
    const pool = new Pool(configCopy, configMainCopy, () => {});
    const blocks1 = {
      id: '1',
      timestamp: '1662753912672',
