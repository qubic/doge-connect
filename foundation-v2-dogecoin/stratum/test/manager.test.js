...
describe('Test manager functionality', () => {
  ...
  test('Test initial manager calculations', () => {
    ...
    expect(manager.extraNoncePlaceholder).toStrictEqual(Buffer.from('f000000ff111111ff222222f', 'hex'));
    expect(manager.extraNonce2Size).toBe(8);
  });
  ...
  test('Test share submission process [3]', () => {
    ...
    const submission = {
      extraNonce1: 0,
      extraNonce2: '0000000000000000'.toString('hex'),
